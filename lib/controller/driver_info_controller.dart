...
class DriverInfoController extends GetxController {
  ...
  RxBool isProvinceBlocked = false.obs;
  ...
  void validateProvinceRequirements() {
    ...
    // Block Newfoundland & Labrador
    if (selectedProvince.value == 'NL') {
      isProvinceBlocked.value = true;
      meetsProvinceRequirements.value = false;
      provinceValidationErrors.value = [
        "Ridesharing is not currently available in Newfoundland and Labrador"
      ];
      return;
    }
    isProvinceBlocked.value = false;
  ...
  bool validatePersonalInfo() {
    ...
    if (isProvinceBlocked.value) {
      ShowToastDialog.showToast(
          "Ridesharing is not available in your province");
      return false;
    }
