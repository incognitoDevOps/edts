...
class OrderModel {
  ...
  // 🔥 CRITICAL: Add missing payment fields
  ...
  OrderModel({
    ...
    this.zone,
    this.zoneId,
    // 🔥 CRITICAL: Add payment fields to constructor
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    print("🔄 [DRIVER ORDER FROM JSON] Parsing order from JSON");
    ...
    print("✅ [DRIVER ORDER FROM JSON] Payment data preserved:");
  ...
  Map<String, dynamic> toJson() {
    ...
    // 🔥 CRITICAL: Add payment data to JSON
  ...
  /// 🔥 CRITICAL: Check if payment data is intact for Stripe payments
  bool hasValidPaymentData() {
    ...
    if (!hasPaymentData) {
      print("⚠️  [DRIVER PAYMENT CHECK] Missing payment data for Stripe order:");
      print("   paymentIntentId: $paymentIntentId");
      print("   preAuthAmount: $preAuthAmount");
      print("   preAuthCreatedAt: $preAuthCreatedAt");
    }
  ...
  void debugPaymentData() {
    print("🔍 [DRIVER PAYMENT DEBUG] Order: $id");
