...
class OrderFreightScreen extends StatelessWidget {
                                    ...
                                    child: ButtonThem.buildButton(
                                      ...
                                      onPress: () async {
                                        ...
                                        WalletTransactionModel adminCommissionWallet = WalletTransactionModel(
                                            id: Constant.getUuid(),
                                            amount: "-${await _calculateDriverChargeForOrder(orderModel, couponAmount)}",
  ...
  /// Calculate driver charge for the order using new payment method logic
  Future<String> _calculateDriverChargeForOrder(InterCityOrderModel orderModel, String couponAmount) async {
    final driver = await FireStoreUtils.getDriverProfile(FireStoreUtils.getCurrentUid());
    if (driver == null || orderModel.adminCommission == null) {
      return "0.0";
    }
    
    final charge = Constant.calculateDriverCharge(
      driver: driver,
      adminCommission: orderModel.adminCommission!,
      rideAmount: double.parse(orderModel.finalRate.toString()),
      discountAmount: double.parse(couponAmount.toString()),
    );
