                                        ...
                                        Expanded(
                                          child: orderModel.status ==
                                              ...
                                              ? ButtonThem.buildBorderButton(
                                                  ...
                                                  onPress: () async {
                                                    // 🔥 CRITICAL: Validate payment data before completing ride
                                                    print(
                                                        "🔍 [DRIVER COMPLETE RIDE] Before completion - Payment state:");
                                                    orderModel
                                                        .debugPaymentData();
                                                    ...
                                                    if (orderModel.paymentType
                                                        ...
                                                        !orderModel
                                                            .hasValidPaymentData()) {
                                                      print(
                                                          "🚨 [DRIVER COMPLETE RIDE] CRITICAL: Payment data missing for Stripe order!");
                                                    ...
                                                    try {
                                                      ...
                                                      ShowToastDialog
                                                          .closeLoader();
                                                      print(
                                                          "❌ [DRIVER COMPLETE RIDE] Error: $e");
                                                      // Don't show error toast if the action was actually successful
          ...
          Row(
            children: [
              ...
              if (orderModel.otp.toString() == controller.otpController.value.text) {
                ...
                // 🔥 CRITICAL: Validate payment data before proceeding
                print("🔍 [DRIVER OTP] Before OTP verification - Payment state:");
                orderModel.debugPaymentData();

                if (orderModel.paymentType?.toLowerCase().contains("stripe") == true &&
                    !orderModel.hasValidPaymentData()) {
                  print("🚨 [DRIVER OTP] CRITICAL: Payment data missing for Stripe order!");
                ...
                try {
                  ...
                  bool success = await FireStoreUtils.safeUpdateAfterOTPVerification(
                      orderModel.id!, controller.otpController.value.text);
                  ...
                  if (success) {
                    ...
                    ShowToastDialog.closeLoader();
                    // ShowToastDialog.showToast("Failed to update ride status".tr);
                  }
                } catch (e) {
                  ShowToastDialog.closeLoader();
                  print("❌ [DRIVER OTP] Error: $e");
