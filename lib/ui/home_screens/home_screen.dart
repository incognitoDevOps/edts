                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(
                                                          height:
                                                              4), // Add some spacing
                                                      Row(
                                                        // Wrap with a Row for icon and text
                                                        mainAxisAlignment:
                                                            MainAxisAlignment
                                                                .center,
                                                        children: [
                                                          ...
                                                          const SizedBox(
                                                              width: 4),
                                                          Text(
                                                            "${serviceModel.passengerCount ?? 1}", // Display passenger count, default to 1
                                                            style: GoogleFonts
                                                                .poppins(
                                                              fontSize:
                                      ...
                                      onPress: () async {
                                        if (controller.selectedPaymentMethod
                                          ...
                                          final qrData = QrRouteModel(
                                            ...
                                            sourceLocationName: controller
                                                .sourceLocationController
                                                .value
                                                .text,
                                            destinationLocationName: controller
                                                .destinationLocationController
                                                .value
                                                .text,
                                            sourceLatitude: controller
                                                .sourceLocationLAtLng
                                                .value
                                                .latitude!,
                                            sourceLongitude: controller
                                                .sourceLocationLAtLng
                                                .value
                                                .longitude!,
                                            destLatitude: controller
                                                .destinationLocationLAtLng
                                                .value
                                                .latitude!,
                                            destLongitude: controller
                                                .destinationLocationLAtLng
                                                .value
                                                .longitude!,
                                            distance: controller.distance.value,
                                            distanceType: Constant.distanceType,
                                            offerRate: controller.selectedType
                                                        .value.offerRate ==
                                                    true
                                                ? controller
                                            ...
                                            finalRate: controller.selectedType
                                                        .value.offerRate ==
                                                    true
                                                ? controller
                                                    .offerYourRateController
                                ...
                                if (contact != null) {
                                  ...
                                  if (fullContact != null &&
                                    ...
                                    ContactModel newContact = ContactModel(
                                      fullName: fullContact.displayName,
                                      contactNumber:
                                          fullContact.phones.first.number,
                                    );

                                    // Check if contact already exists
                                    bool contactExists = controller.contactList
                                        .any((contact) =>
