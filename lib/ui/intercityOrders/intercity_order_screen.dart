...
import 'package:customer/ui/orders/order_screen.dart' show AnimatedDots;
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Visibility(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              (orderModel.acceptedDriverId != null && orderModel.acceptedDriverId!.length == 1)
                                                                  ? Theme(
                                                                      ...
                                                                      ? Visibility(
                                                                          ...
                                                                          child: SizedBox(
                                                                            ...
                                                                            child: MaterialButton(
                                                                              ...
                                                                              child: const AnimatedDots(text: 'Searching for driver', dotCount: 4),
                                                                            ),
                                                                          ),
                                                                        )
                                                                      : ButtonThem.buildButton(
                                                                          context,
                                                                          title: 'Driver found (orderModel.acceptedDriverId!.length)'.tr,
                                                                          btnHeight: 44,
                                                                          onPress: () async {
                                                                            Get.to(const InterCityAcceptOrderScreen(), arguments: {
                                                                              "orderModel": orderModel,
