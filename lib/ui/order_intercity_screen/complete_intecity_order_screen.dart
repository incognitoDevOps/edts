                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        Text(
                                                          "(-${Constant.amountShow(amount: controller.calculateDriverCharge().toString())})",
                                                          style: GoogleFonts.poppins(fontWeight: FontWeight.w600, color: Colors.red),
                                                        ),
                                                      ],
                                                    ),
                                                ...
                                                Text(
                                                  "Note : ${controller.driverUser.value.paymentMethod == 'flat_rate' ? 'Flat rate charge' : 'Commission'} will be debited from your wallet balance. \n ${controller.driverUser.value.paymentMethod == 'flat_rate' ? 'Flat rate applies per ride regardless of ride amount.' : 'Commission will apply on Ride Amount minus Discount(if applicable).'}"
                                                      .tr,
