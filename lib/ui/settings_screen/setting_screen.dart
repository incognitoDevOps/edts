...
import 'package:driver/ui/settings_screen/payment_method_section.dart';
                ...
                : Column(
                    children: [
                      ...
                      Expanded(
                        ...
                        //         width: 20,
                        //       ),
                        //       Expanded(child: Text("Language".tr, style: GoogleFonts.poppins(fontWeight: FontWeight.w500))),
                        //       SizedBox(
                        //         width: Responsive.width(26, context),
                        ...
                        //               Preferences.setString(Preferences.languageCodeKey, jsonEncode(value.toJson()));
